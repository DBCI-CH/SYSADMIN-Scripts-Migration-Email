...
import-csv $inputfile | foreach {new-mailuser -name $_.displayname -externalemailaddress  -identity Add-MailboxfolderPermission -identity ($_.PrimaryMailboxEmail + ":\calendrier") -User $_.delegate -AccessRights $_.delegaterights}
